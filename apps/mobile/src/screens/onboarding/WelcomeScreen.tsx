    ...
    <SafeAreaView style={styles.container} testID="screen.welcome">
      <View style={styles.content}>
        ...
        <Text style={styles.body}>
          To start, you'll pair your phone with your partner's by scanning each other's QR code (or
          by sharing a 6-character code if you're apart). Then you'll jointly choose a Safe Word
