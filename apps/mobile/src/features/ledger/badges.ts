...
export const BADGE_MILESTONES: readonly Badge[] = [
  ...
  { threshold: 250, name: 'Ember', emoji: '🎇' },
  { threshold: 500, name: 'Kindling', emoji: '🪵' },
  { threshold: 750, name: 'Flicker', emoji: '🕯️' },
  { threshold: 1_000, name: 'Warm Glow', emoji: '🏮' },
  { threshold: 1_500, name: 'Steady Flame', emoji: '🔥' },
  { threshold: 2_000, name: 'Campfire', emoji: '🎆' },
  { threshold: 3_000, name: 'Torch', emoji: '🔦' },
  { threshold: 5_000, name: 'Bonfire', emoji: '🔥' },
  { threshold: 7_500, name: 'Beacon', emoji: '🗼' },
  { threshold: 10_000, name: 'Wildfire', emoji: '🌋' },
  { threshold: 15_000, name: 'Inferno', emoji: '♨️' },
  { threshold: 25_000, name: 'Sunrise', emoji: '🌅' },
  { threshold: 40_000, name: 'Daybreak', emoji: '🌄' },
  { threshold: 50_000, name: 'Radiant', emoji: '💎' },
  { threshold: 75_000, name: 'Brilliant', emoji: '🔆' },
  { threshold: 100_000, name: 'Luminary', emoji: '💫' },
  { threshold: 150_000, name: 'Aurora', emoji: '🌌' },
  { threshold: 250_000, name: 'Shooting Star', emoji: '🌠' },
  { threshold: 400_000, name: 'Comet', emoji: '☄️' },
  { threshold: 500_000, name: 'Constellation', emoji: '⭐' },
  { threshold: 750_000, name: 'Nebula', emoji: '🌫️' },
