...
module.exports = {
  ...
  collectCoverageFrom: [
    ...
    'src/features/couple-channel/build-engine.ts',
    'src/features/couple-channel/outbox.ts',
    'src/features/couple-channel/projector.ts',
    'src/features/couple-channel/ratchet-store.ts',
    'src/features/couple-channel/save-for-partner.ts',
    ...
    'src/features/roleplay/actions.ts',
    'src/features/roleplay/loop-sweeper.ts',
    'src/features/roleplay/store.ts',
